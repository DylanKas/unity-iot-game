...
public class MovementCustom2
{
    ...
    private void Update()
    {
        isGoingRight = variableJoystick.Horizontal > 0;
        isGoingLeft = variableJoystick.Horizontal < 0;
        isGoingTop = variableJoystick.Vertical > 0;
        isGoingDown = variableJoystick.Vertical < -0.95;
       
        Debug.Log(isGoingDown);        
    ...
    public void checkInput()
    {
        ...
        if (Input.GetKeyDown(KeyCode.S) || isGoingDown)
        {
        ...
        else if (!isGoingDown && !isGoingRight && !isGoingLeft)
        {
